...
| 盲走上楼梯 | [stairs-dwaq-ppo-beta-vae](https://github.com/tulay-hub/stairs-dwaq-ppo-beta-vae) | DWAQ + blind stair curriculum | 76 / 380 -> 21 |
...
各训练项目的演示视频已经放在对应仓库的 `docs/media/`，并在各自 README 的训练说明附近嵌入；共享框架 README 展示通用自平衡演示。视频是结果展示，不替代 observation/action、MuJoCo replay 或真机安全验收。
